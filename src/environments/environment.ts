    ...
    'north': [
      {
        ...
        'cost': 167,
        'type': '',
        'description': `Main or side dish. Mixed rice dish, optional spices, optional vegetables, meats
         or seafood. Can be served with plain yogurt.`
      }, {
        'id': 5,
        'name': 'Butter chicken',
        ...
        'cost': 418,
        'type': 'Vegetarian',
        'description': `Gram flour balls fried with vegetables. Gram flour, veggies,
      rolled into balls with gram flour and fried in oil and then cooked with curry.`
      }, {
        'id': 23,
        'name': 'Kulfi falooda',
        ...
        'description':
          `Normally served as an entree or appetiser. Potatoes, onions, peas, coriander,
       and lentils, may be served with a mint or tamarind sauce`
      }, {
        'id': 33,
        'name': 'Shahi paneer',
        ...
        'cost': 434,
        'type': 'Vegetarian',
        'description': `A popular Indian, as well as Punjabi and Nepalese dish, made with paneer in a
        thick cream and tomato gravy and spices`
      }, {
        'id': 34,
    ...
    'south': [
      {
        ...
        'cost': 271,
        'type': 'Vegetarian',
        'description': `Light and subtle-flavored Kerala dish prepared from white gourd,
        ash-gourd or black-eyed peas, coconut milk and ginger seasoned with coconut oil.`
      }, {
        'id': 16,
        'name': 'Parotta',
        'image': 'Parotta.jpg',
        ...
        'cost': 102,
        'type': 'Vegetarian',
        'description': `Lentil soup cooked with vegetables and a blend of south Indian spices
         (masala). Usually taken with rice, idli, dosa, pongal or upma.`
      }, {
        'id': 22,
        'name': 'Sevai',
        ...
        'cost': 465,
        'type': 'Vegetarian',
        'description': `A stuffed (moong gram dal and jaggery or coconut poornam) paratha.
        Dish native to South and West India in the states of (Karnataka, Andhra Pradesh and Maharashtra`
      }, {
        'id': 28,
        'name': 'Pesarattu',
        'image': 'Pesarattu.jpg',
